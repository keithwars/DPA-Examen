...
public class Test {
	...
	public static void main(String[] args) throws DomoticaException {
		...
		// This is my test view including the OpenDoors Command
		Bathroom bathroom = null;
		OpenDoors openDoors = new OpenDoors(bathroom);
		openDoors.execute();
		
		// This is my test view including the CloseDoors Command
		CloseDoors closeDoors = new CloseDoors(bathroom);
		closeDoors.execute();
